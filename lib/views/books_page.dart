                ...
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                         children: [
                           Image.asset('assets/12-classe/filosofia12.jpg',
                           height: 120,
                           ),
                      ...
                      Padding(
                        ...
                        child: Column(
                         children: [
                           Image.asset('assets/12-classe/fisica12.jpg',
                            height: 120,),
                      ...
                      Column(
                       children: [
                         Image.asset('assets/12-classe/geografia12.jpg',
                       //   height: 120,
                          width: 100,),
                           const SizedBox(height: 5,),
                        const Text('Biologia')
                      ...
                      Padding(
                        ...
                        child: Column(
                         children: [
                           Image.asset('assets/12-classe/matematica12.jpg',
                            height: 120,),
                             const SizedBox(height: 5,),
                           const Text('Biologia')
                         ],
                      ...
                      SizedBox(
                        child: Column(
                         children: [
                           Image.asset('assets/12-classe/quimica12.PNG',
                            height: 120,),
                           const SizedBox(height: 5,),
                           const Text('Biologia')
                         ],
